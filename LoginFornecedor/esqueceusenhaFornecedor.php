    ...
    if(isset($_POST['ok']))
    {
        ...
        if($total > 0) {
            ...
            if(1 == 1/*mail($email, "Sua nova senha", "Sua nova senha é ".$novaSenha)*/) {
                ...
                if($sql_query) {
                    echo  "<script>alert('Senha alterada com sucesso! Sua nova senha é  >>>>>    $novaSenha'); location.href='loginFornecedor.php';</script>";
                }
            }
        }
    }
...
<body id="fundoRecuSenha">
    ...
    <form action="esqueceusenhaFornecedor.php" method="POST"  class="divFundo formRecuSenha">
    ...
    <footer id="rodape">
        <div id="areaLinksPag">
            <a href="./LoginFree/suporte.php" class="linkPaginaSite">contato</a>
            <a href="tela_de_cadastro_fornecedor.php" class="linkPaginaSite">cadastro</a>
            <a href="loginFornecedor.php" class="linkPaginaSite">login</a>
        </div>
